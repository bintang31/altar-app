...
type Drd struct {
	...
	Tglupload      time.Time `gorm:"default:CURRENT_TIMESTAMP" json:"tglupload"`
	Tglbayar       time.Time `gorm:"default:CURRENT_TIMESTAMP" json:"tglbayar"`
...
//DrdbyPetugas : Struct Entity sort petugas
type DrdbyPetugas struct {
	Nosamb         string  `json:"nosamb" gorm:"primary_key"`
	Periode        string  `json:"periode" gorm:"not null; unique; size:50"`
	Pdam           string  `json:"pdam" gorm:"not null; unique; size:50"`
	Pakai          int     `json:"pakai" gorm:"null"`
	...
	Lunas          string  `json:"lunas" gorm:"null; size:10"`
	Total          float64 `json:"total" gorm:"null"`
	Tglupload      int     `json:"tglupload"`
	Tglbayar       int     `json:"tglbayar"`
	TglbayarString string  `json:"tglbayar_string" gorm:"null"`
	TransactionsID uint64  `json:"transactions_id" gorm:"null"`
}

//DrdbyPetugass : Struct list DRD
type DrdbyPetugass []DrdbyPetugas
